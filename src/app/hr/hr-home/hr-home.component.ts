...
@Component({
  selector: 'app-hr-home',
   imports: [LeaveFormComponent,SidebarComponent,CommonModule, FormsModule, ReactiveFormsModule,FooterComponent,ProfileComponent,LeaveDashboardComponent,UsersDashboardComponent],
